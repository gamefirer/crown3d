...
public class DefaultMutableTreeNode implements MutableTreeNode{
	...
	public var color:ASColor = null;		// 自定义颜色
	...
	public function hasColor():ASColor{
		return color;
	}
	...
	public function findChildByUserObject(usrObj:*):DefaultMutableTreeNode
	{
		var findNode:DefaultMutableTreeNode = null;
		var childNode:DefaultMutableTreeNode;
		for(var i:int=0; i<	_children.size(); i++)
		{
			childNode = _children.get(i);
			if(childNode.userObject == usrObj)
			{
				findNode = childNode;
				break;
			}
