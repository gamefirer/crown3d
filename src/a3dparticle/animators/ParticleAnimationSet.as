package a3dparticle.animators
{
	 ...
	 * @author ...
	 */
	public class ParticleAnimationSet implements IAnimationSet
	{
		...
		//vertex
		public var timeConst:ShaderRegisterElement;				// 时间
		...
		public var vertexTime:ShaderRegisterElement;				// 当前时间
		public var vertexLife:ShaderRegisterElement;				// 生命比例
		public var zeroConst:ShaderRegisterElement;				// 常量0
		public var OneConst:ShaderRegisterElement;
		public var TwoConst:ShaderRegisterElement;
		public var cameraPosConst:ShaderRegisterElement;			// 摄像机位置
		...
		public var textSample:ShaderRegisterElement;				// 贴图
		...
		public function dispose():void
		{
			...
			_particleActions.length = 0;
			_pushOrderActions.length = 0;
		}
	}
