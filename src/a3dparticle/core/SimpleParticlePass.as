package a3dparticle.core
{
	...
	public class SimpleParticlePass extends MaterialPassBase
	{
		...
		override public function set animationSet(value : IAnimationSet) : void
		{
			...
			if (value is ParticleAnimationSet)
			{
				_particleMaterial.initAnimation(value as ParticleAnimationSet);
		...
		private function get _particleAnimation():ParticleAnimationSet
		{
			return  animationSet as ParticleAnimationSet;
		}
