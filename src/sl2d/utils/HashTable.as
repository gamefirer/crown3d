 ...
 *     if (thisperson != null) {
 *         Debug.bltrace("two name is "+thisperson.name);
 *         Debug.bltrace("two age is "+thisperson.age);
 *         Debug.bltrace("two sex is "+thisperson.sex);
 *     }else{
 *         Debug.bltrace("two is not in friends!");
 *     }
 * </listing>
 *</p>
 * @author iiley
