package away3d.materials.methods
{
	...
	public class ShadingMethodBase extends EventDispatcher
	{
		...
		protected var _colorFragmentReg : ShaderRegisterElement;		// 顶点色输入寄存器
		...
		arcane function get colorFragmentReg() : ShaderRegisterElement
		{
			return _colorFragmentReg;
		}
		
		arcane function set colorFragmentReg(value : ShaderRegisterElement) : void
		{
			_colorFragmentReg = value;
		}
