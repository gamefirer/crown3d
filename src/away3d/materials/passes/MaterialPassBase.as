package away3d.materials.passes
{
	...
	public class MaterialPassBase extends EventDispatcher
	{
		 ...
		 * 	常量寄存器
		 *	vc0-3 为mvp
		 * 	vc4 为（textureRatioX, textureRatioY, 1, 1)
		 * 
		 * 	输入寄存器
		 * 	va0 为顶点位置
		 * 	
...
//		arcane function getProjectedTargetRegister() : String { return _projectedTargetRegister; }
//		arcane function getVertexRenderDataRegister() : String { return _vertexRenderDataRegister; }
...
// AGAL RELATED STUFF
		...
		arcane function updateProgram(stage3DProxy : Stage3DProxy) : void
		{
			...
			// 显示生成的agal
			Debug.agalTrace ("Compiling AGAL Code:");
			Debug.agalTrace ("--------------------");
			Debug.agalTrace (vertexCode);
			Debug.agalTrace ("--------------------");
			Debug.agalTrace (fragmentCode);
