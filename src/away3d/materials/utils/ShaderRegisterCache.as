package away3d.materials.utils
{
	...
	{
		private var _fragmentTempCache : RegisterPool;				// ps暂存寄存器
		private var _vertexTempCache : RegisterPool;				// vs暂存寄存器
		private var _varyingCache : RegisterPool;					// 变量寄存器
		private var _fragmentConstantsCache : RegisterPool;		// ps常量寄存器
		private var _vertexConstantsCache : RegisterPool;			// vs常量寄存器
		private var _textureCache : RegisterPool;					// 采样寄存器
		private var _vertexAttributesCache : RegisterPool;			// vs输入寄存器
