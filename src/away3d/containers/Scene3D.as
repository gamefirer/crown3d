package away3d.containers
{
	...
	public class Scene3D extends EventDispatcher
	{
		...
		private var _partitions : Vector.<Partition3D>;		// 当前场景树中，所有的 空间划分对象
		...
		{
			_sceneGraphRoot.update(curTime, deltaTime);
		}
		...
		arcane function registerPartition(entity : Entity) : void
		{
			...
			entity.implicitPartition.markForUpdate(entity);			// 通知该partition,需要更新该entity
		}
