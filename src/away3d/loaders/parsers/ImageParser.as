...

{
	...
	public class ImageParser extends ParserBase
	{
		...
		protected override function proceedParsing() : Boolean
		{
			if (_data is Bitmap) {
				Debug.assert(false);
				var asset : BitmapTexture = BitmapTextureCache.instance().getTexture(Bitmap(_data).bitmapData);
		...
		{
			Debug.assert(false);
			var asset : BitmapTexture = BitmapTextureCache.instance().getTexture(Bitmap(_loader.content).bitmapData);
