	...
	public class SegmentSet extends Entity implements IRenderable
	{
		...
		public function getIndexBuffer( stage3DProxy:Stage3DProxy ):IndexBuffer3D
		{
			if ( _indexContext3D != stage3DProxy.context3D || _indexBufferDirty )
			{
				if(_indexBuffer)
				{
					Context3DProxy.disposeIndexBuffer(_indexBuffer);
				}
				_indexBuffer = Context3DProxy.createIndexBuffer( _numIndices );
				Context3DProxy.uploadIndexBufferFromVector(_indexBuffer, _indices, 0, _numIndices);
		...
		public function getVertexBuffer( stage3DProxy:Stage3DProxy ):VertexBuffer3D
		{
			...
			if ( _vertexContext3D != stage3DProxy.context3D || _vertexBufferDirty ) 
			{
				if(_vertexBuffer)
				{
					Context3DProxy.disposeVertexBuffer(_vertexBuffer);
				}
				_vertexBuffer = Context3DProxy.createVertexBuffer( _numVertices, 11 );
				Context3DProxy.uploadVertexBufferFromVector(_vertexBuffer, _vertices, 0, _numVertices);
