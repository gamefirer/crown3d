	...
	public class AGALProgram3DCache
	{
		...
		public function setProgram3D(pass : MaterialPassBase, vertexCode : String, fragmentCode : String) : void
		{
			...
			if (_program3Ds[key] == null) {
				...
				_ids[key] = _currentId;
				++_currentId;
				program = Context3DProxy.createProgram(stageIndex);	// _stage3DProxy._context3D.createProgram();
		...
		{
			Context3DProxy.disposeProgram(_program3Ds[key]);	// _program3Ds[key].dispose();
