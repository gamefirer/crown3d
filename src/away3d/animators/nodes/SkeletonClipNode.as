package away3d.animators.nodes
{
	...
	public class SkeletonClipNode extends AnimationClipNodeBase implements ISkeletonAnimationNode
	{
		...
		private var _currentPose : SkeletonPose;			// 上一帧
		private var _nextPose : SkeletonPose;				// 下一帧
		private var _oldFrame:uint;
		private var _timeDir:int;
		
		protected var _skeletonPose : SkeletonPose = new SkeletonPose();			// 结果
		protected var _skeletonPoseDirty : Boolean = true;
