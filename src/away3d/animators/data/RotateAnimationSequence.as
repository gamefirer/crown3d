...
package away3d.animators.data
{
	...
	public class RotateAnimationSequence extends AnimationSequenceBase
	{
		public var frames : Vector.<RotateAnimationFrame>;
		
		public function RotateAnimationSequence(name:String)
		{
			super(name);
			
			frames = new Vector.<RotateAnimationFrame>();
		}
		
		public function addFrame(frame : RotateAnimationFrame, duration : Number) : void
		{
			insertFrame(frame, duration, -1);
		}
		
		public function insertFrame(frame : RotateAnimationFrame, duration : Number, pos : int) : void
		{
